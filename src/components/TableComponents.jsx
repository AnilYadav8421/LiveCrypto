        ...
        <>
            <div className='flex flex-col mt-9 border border-gray-400 rounded'>
                <table className='w-full table-auto'>
                    ...
                    <tbody>
                        {cryptoData.map((data) => (
                            <tr key={data.id} className="text-center text-base border-b border-gray-300 hover:bg-gray-800 last:border-b-0">
            ...
            <div className='flex items-center justify-between mt-4 h-[2rem]'>
                <span>Data provided by <a className='text-cyan-300' href="http://www.coingecko.com" rel='noreferrer' target={'_blank'}>CoinGecko</a></span>
                <Pagination />
            </div>
        </>
    );

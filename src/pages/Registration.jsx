            ...
            >
                ...
                <div className="w-full mt-8">
                    <div className="mx-auto max-w-xs sm:max-w-md md:max-w-lg flex flex-col gap-4">
                        ...
                        />
                        <button className="mt-5 tracking-wide font-semibold bg-cyan-500 text-gray-100 w-full py-4 rounded-lg hover:bg-cyan-400 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                            <svg
                        ...
                        <p className="mt-6 text-xs text-gray-600 text-center">
                            ...
                            <a href="/login">
                                <span className="text-cyan-500 font-semibold">Login</span>
                            </a>
                        </p>
                    </div>
                </div>
